          ...
          <>
            ...
            >
              ...
              <form
                ...
                className="flex items-center bg-taupe/10 rounded-full px-3 py-2 mb-6"
              >
                    ...
                    {cat.hasSubmenu ? (
                      <>
                        <button
                          ...
                          className="w-full flex items-center justify-between py-3 text-brand hover:text-gold transition-colors border-b border-taupe/10"
                        >
                            ...
                            >
                              {cat.subcategories.map((sub) => (
                                <button
                                  ...
                                  className="w-full text-left py-2 text-sm text-charcoal/80 hover:text-brand transition-colors flex items-center gap-2"
                                >
