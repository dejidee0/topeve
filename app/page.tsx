...
const categoryTiles = [
  { name: 'Dresses', href: '/shop?category=dresses', image: 'https://images.pexels.com/photos/1055691/pexels-photo-1055691.jpeg?auto=compress&cs=tinysrgb&w=1200' },
  { name: 'Bubus & Agbadas', href: '/shop?category=bubus', image: 'https://images.pexels.com/photos/3394658/pexels-photo-3394658.jpeg?auto=compress&cs=tinysrgb&w=1200' },
  { name: 'Two Piece Sets', href: '/shop?category=two-piece', image: 'https://images.pexels.com/photos/3394310/pexels-photo-3394310.jpeg?auto=compress&cs=tinysrgb&w=1200' },
  { name: 'Tops & Blouses', href: '/shop?category=tops', image: 'https://images.pexels.com/photos/1926620/pexels-photo-1926620.jpeg?auto=compress&cs=tinysrgb&w=1200' },
  { name: 'Bottoms', href: '/shop?category=bottoms', image: 'https://images.pexels.com/photos/1631181/pexels-photo-1631181.jpeg?auto=compress&cs=tinysrgb&w=1200' },
  { name: 'Jumpsuits', href: '/shop?category=jumpsuits', image: 'https://images.pexels.com/photos/1721558/pexels-photo-1721558.jpeg?auto=compress&cs=tinysrgb&w=1200' },
  { name: 'Accessories', href: '/accessories', image: 'https://images.pexels.com/photos/1926769/pexels-photo-1926769.jpeg?auto=compress&cs=tinysrgb&w=1200' },
  { name: 'Menswear', href: '/ready-to-wear/men', image: 'https://images.pexels.com/photos/1933873/pexels-photo-1933873.jpeg?auto=compress&cs=tinysrgb&w=1200' },
];
    ...
    <div>
      ...
      <section className="container py-16 lg:py-24">
        <div className="text-center mb-12">
          <h2 className="font-display text-h1 uppercase tracking-caps mb-2">New Arrivals</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-0 lg:gap-12">
          ...
          <div className="flex flex-col justify-center space-y-6">
            ...
            <p className="text-lg text-muted leading-relaxed">
              From traditional ceremonies to contemporary gatherings, our collection celebrates
              the richness of African heritage with modern sophistication. Each piece is carefully
              selected to ensure you make a statement wherever you go.
            </p>
            <div>
              <Button
                asChild
      ...
      <section className="container py-16 lg:py-24">
        <div className="text-center mb-12">
          <h2 className="font-display text-h1 uppercase tracking-caps mb-2">Shop By Category</h2>
          <div className="w-16 h-0.5 bg-accent mx-auto"></div>
        </div>
      ...
      {blogPosts.length > 0 && (
        <section className="container py-16 lg:py-24">
          <div className="text-center mb-12">
            <h2 className="font-display text-h1 uppercase tracking-caps mb-2">From The Journal</h2>
            <div className="w-16 h-0.5 bg-accent mx-auto"></div>
          </div>
